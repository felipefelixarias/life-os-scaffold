...
### Schema
```csv
log_id,date,activity,domain,duration_mins,start_time,end_time,task_id,notes,last_updated
```
...
| `domain` | String | No | Life area |
| `duration_mins` | Integer | No | Total minutes spent if you prefer logging a duration directly |
...
### Example
```csv
log_001,2026-04-01,Code review session,work,75,14:30,15:45,code_review_task,Very productive session,2026-04-01
```
