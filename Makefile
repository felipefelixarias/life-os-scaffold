.PHONY: help setup test lint clean gcal-agenda gcal-test csv-check deps-check health refresh-examples dev-setup format security type-check dev-install pre-commit-install task-stats
...
task-stats: ## Show task analytics (due dates, staleness, portfolio rollup)
	@python3 $(LIFE_OS)/scripts/task_analytics.py
