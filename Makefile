.PHONY: help setup test lint clean gcal-agenda gcal-test csv-check deps-check health refresh-examples dev-setup format security type-check dev-install pre-commit-install project-stats
...
project-stats: ## Show project portfolio analytics (status, staleness, overdue)
	@python3 $(LIFE_OS)/scripts/project_analytics.py
