.PHONY: help setup test lint clean gcal-agenda gcal-test csv-check deps-check health refresh-examples dev-setup format security type-check dev-install pre-commit-install export
...
export: ## Export canonical CSVs to JSON + Markdown under outputs/exports/
	@python3 $(LIFE_OS)/scripts/export_data.py --format json,markdown
