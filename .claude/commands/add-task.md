...
3. Infer reasonable defaults for any missing fields:
   - Priority: P2 (medium) unless urgency words are used
...
→ title=Buy groceries, domain=personal, priority=P3, effort=30, energy=low

User: "I need to review the PR by Friday"
→ title=Review PR, domain=career, priority=P1, due_date=Friday, effort=45, energy=high

User: "remind me to call mom this weekend"
→ title=Call mom, domain=relationships, priority=P2, due_date=Saturday, effort=15, energy=low
